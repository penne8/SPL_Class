...
public abstract class MicroService implements Runnable {
    ...
    private final HashMap<Class<? extends Message>, Callback> CALLBACKS;
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        if (!CALLBACKS.containsKey(type)) {
            // If not - add a callback for that event type
            CALLBACKS.put(type, callback);
            // And subscribe the MS to handle this event type
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        ...
        if (!CALLBACKS.containsKey(type)) {
            // If not - add a callback for that event type
            CALLBACKS.put(type, callback);
            // And subscribe the MS to handle this broadcast type
    ...
    /**
     * Update the diary of the termination time of the micro-service
     */
